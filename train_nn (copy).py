...
data = AudioLocationDataset(use_subset=180, csv="./data_clip_label/label.csv", transform = ToTensor())
...
model.load_state_dict(torch.load('./trained_models/120.checkpoint'))
